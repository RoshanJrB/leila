...
echo "valeur du parametre 'langue' envoyé avec l'url : ";
//verifie si le param 'langue' existe avant de l'utiliser
if(isset($_GET['langue'])){
  echo $_GET['langue'];
}
//test
echo '<hr/>contenue du tableau GET en PHP<hr/>'; 
print_r($_GET);
*/

// A -determiner la langue par defaut
$langueChoisie = 'fr';

// B verifier si l"utilisateur a deja fait un choix de langue auparavant
if(isset($_COOKIE['leila_langue'])){
  $langueChoisie = $_COOKIE['leila_langue'];
}

// C - si l'utilisateur  choisi une langue en cliquant un lien dans le nav
if(isset($_GET['langue'])){
  $langueChoisie = $_GET['langue'];
  // C2 retenir le choix de l'utilisateur
  setcookie('leila_langue', $langueChoisie, time() + 365*24*60*60*2);
}
...
<head>
  ...
  <title><?php echo $meta[$page]["titre"]; ?> | Restaurant Leila</title>
  <meta name="description" content="<?php echo $meta[$page]["desc"]; ?>">
  ...
  <div id="conteneur" class="page-<?php echo $page ?>">
    <header>
      <div class="barre-haut">
        ...
        <?php
        //afficher le lien vers la page d'accueil uniquement lorsque la page d'accueil n'est pas affiché
        if ($page != 'accueil') {
        ?>
      ...
      <div class="titre-page">
        ...
        <h1><?php echo strtoupper($meta[$page]["h1"]); ?></h1>
